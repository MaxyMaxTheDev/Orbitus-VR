...
Use the Firebase **web app** config values exactly as shown in Firebase Console. After changing any `NEXT_PUBLIC_FIREBASE_*` value in Vercel, redeploy so the browser bundle receives the updated key.
