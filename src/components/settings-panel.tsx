    ...
    <Sheet>
      ...
      <SheetContent className="bg-background/80 backdrop-blur-xl border-primary/30 text-foreground">
        <SheetHeader>
          ...
          <SheetDescription>Customize your XenovaVR experience.</SheetDescription>
        </SheetHeader>
        ...
        <div className="grid gap-4 py-4">
          <div className="flex items-center justify-center w-full">
            <label
              ...
              className="flex flex-col items-center justify-center w-full h-64 border-2 border-dashed rounded-lg border-border hover:border-accent hover:bg-black/20"
            >
