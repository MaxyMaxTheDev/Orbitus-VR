      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <Card className="bg-primary/20 border-primary/30">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-sm font-medium text-accent">Time</CardTitle>
        ...
        <Card className="lg:col-span-2 bg-primary/20 border-primary/30">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-sm font-medium text-accent">Quote of the Day</CardTitle>
         ...
         <Card className="md:col-span-3 bg-primary/20 border-primary/30">
          <CardHeader>
            <CardTitle className="text-sm font-medium text-accent">Welcome to NexusVR</CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-foreground">Your virtual space is ready. Launch apps from the main screen to begin your immersive experience. Customize your environment in the Theme Studio or chat with the AI Assistant.</p>
          </CardContent>
        </Card>
      </div>
    </div>
